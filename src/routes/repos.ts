...
import { ACCEPTED_IMAGES_EXTENSIONS, DEV_DOMAIN, DOMAIN, GITHUB_USER, PUBLIC_FOLDER, REPO_IMAGES_FOLDER } from '../../settings'
...
router.post("/image/:name", async (req, res) => {
    ...
    repo.image_url = `${DOMAIN}/public/repo/images/${repo.image}`
